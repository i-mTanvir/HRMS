...
<body>
    ...
    ?>
        ...
        <div id="hero">
            <div id="hero-left">
                ...
                <div id="hero-subtitle">Need a trusted repair pro? Find and book the right specialist online, choose
                    your time, and get transparent pricing for a quick, reliable fix.</div>
                <div id="hero-search">
        ...
        <div id="offers">
            <div id="offers-title">Hot Deals 🔥</div>
            <div id="offer-cards">
                <div id="offer-card-one">
                    <div class="offer-text">
                        <div class="offer-title">House Cleaning</div>
                        <div class="offer-discount"><span class="offer-percent">50%</span> OFF</div>
                    </div>
                    <div class="offer-image-wrap">
                        <img class="offer-image" src="media/cleaning.png" alt="Cleaning service">
                    </div>
                </div>
                <div id="offer-card-two">
                    <div class="offer-text">
                        <div class="offer-title">House Cleaning</div>
                        <div class="offer-discount"><span class="offer-percent">50%</span> OFF</div>
                    </div>
    ...
    <div id="footer-bottom">
     ...
     <!--*Typing styling from "https://codepen.io/"-->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const holdTime = 1200;  // pause after a word is fully typed
            ...
            function cycleText() {
                ...
                void typingEl.offsetWidth; // force reflow to restart animation
